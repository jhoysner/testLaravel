              ...
              <div class="col-md-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4>Reproductor Create</h4>
      
                        <a href="{{route('home')}}" class="btn btn-info mb-4">Home</a>
                      ...
                      <form action="{{route('reproductores.update', $data->id)}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Raza</label>
                                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="raza">
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <input type="text" class="form-control" name="cantidad" value="{{$data->cantidad}}" >
                                </div>
